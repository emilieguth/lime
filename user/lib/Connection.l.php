...
class ConnectionLib {
	...
	protected static function getFromSession(): User {
		...
		User::model()
			->select([
				'email', 'seniority', 'firstName', 'lastName', 'bio', 'country',
				'verified', 'bounce', 'deletedAt',
				'role' => ['can'],
				'vignette'
			])
			->get($eUser);
	 ...
	 */
	public static function logInUser(User $eUser, bool $remember): bool {
