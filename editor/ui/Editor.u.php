			...
			'<form id="editor-video-form">'.
				'<div class="input-group">'.
					...
					'<span class="input-group-btn">'.
						' <button type="submit" id="editor-video-save" class="btn btn-primary">'.s("Insérer").'</button>'.
					'</span>'.
				'</div>'.
			'</form>',
			layer: FALSE
